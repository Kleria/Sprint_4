...
public class SliderTests extends BaseTest {
    ...
    public SliderTests(String headerText, String textToCompare) {
    ...
    public void faqHasSlideresOpenTest() {
        MainPage objMainPage = new MainPage(driver, headerText, textToCompare);
        objMainPage.agreeToCookieUsage();
        String accordeonText = objMainPage.openAccordeonAndGetText();
